 ...
 * 
 */
public final class InternalThreadManager implements AutoCloseable {
  private static final int MAX_THREADS = 5;
  public static final ExecutorService service = Executors.newFixedThreadPool(MAX_THREADS);

  private InternalThreadManager() {}
   ...
   * methods idempotent.
   * 
   * @throws SecurityException if this resource cannot be closed
   */
  @Override
